...
<script>
import '__STATIC__/static/ueditor/ueditor.config.js'
import '__STATIC__/static/ueditor/ueditor.all.js'
import '__STATIC__/static/ueditor/lang/zh-cn/zh-cn.js'
import '__STATIC__/static/ueditor/ueditor.parse.js'
  ...
  data() {
    return {
      ...
      defaultConfig: {
        ...
        UEDITOR_HOME_URL: process.env.BASE_URL ? process.env.BASE_URL + 'static/ueditor/' : '/static/ueditor/',
